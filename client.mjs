"use strict";
import { SCREEN_PADDING, PLAYER_HEIGHT, PLAYER_WIDTH, BALL_RADIUS, GameState, init_ball, checkWin, updateBallState, updatePlayerState, applyCollidBallPlayer } from './common.mjs';
const canvas = document.getElementById("canvas");
if (canvas === null)
    throw new Error("No element with id `canvas`");
const ctx = canvas.getContext('2d');
if (ctx === null)
    throw new Error("No 2D context");
let gameState = GameState.WaitingPlayer;
const p1 = {
    box: {
        x: SCREEN_PADDING,
...
var loop = function (time) {
    ...
    else if (gameState === GameState.WaitingPlayer) {
